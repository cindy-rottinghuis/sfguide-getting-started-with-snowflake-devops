...
CREATE OR REPLACE API INTEGRATION git_api_integration
  ...
  API_ALLOWED_PREFIXES = ('https://github.com/cindy-rottinghuis') -- INSERT YOUR GITHUB USERNAME HERE
  ENABLED = TRUE;
...
--   ORIGIN = 'https://github.com/cindy-rottinghuis/sfguide-getting-started-with-snowflake-devops'; -- INSERT URL OF FORKED REPO HERE
